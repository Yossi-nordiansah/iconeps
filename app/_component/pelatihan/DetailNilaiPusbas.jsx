...
const DetailNilaiPusbas = ({ isOpen, close, data }) => {
            ...
            <div className="bg-white p-5 rounded shadow-md w-full max-w-md">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full table-auto border border-gray-400">
                        ...
                        <tbody>
                            <tr>
                                <td className="border border-gray-400 sm:px-4 sm:py-2 py-1 px-1 text-center">{data.listening}</td>
                                <td className="border border-gray-400 sm:px-4 sm:py-2 py-1 px-1 text-center">{data.structure}</td>
                                <td className="border border-gray-400 sm:px-4 sm:py-2 py-1 px-1 text-center">{data.reading}</td>
                                <td className="border border-gray-400 sm:px-4 sm:py-2 py-1 px-1 text-center">{data.total}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <h1 className='text-center mt-2'>Batas minimal nilai adalah 400</h1>
                <button
...
export default DetailNilaiPusbas;
