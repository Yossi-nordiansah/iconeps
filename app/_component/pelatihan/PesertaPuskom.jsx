    ...
    return (
        <div className='flex sm:gap-6 gap-2 sm:flex-row flex-col sm:min-w-[580px] min-w-72 max-w-72 w-full bg-gradient-to-b shadow-xl from-blue-950 to-blue-900 sm:p-4 p-3 rounded-lg mb-10'>
            ...
            <div className='text-white text-nowrap w-full'>
                ...
                <div className="flex w-full sm:justifty-left justify-center flex-col items-center mt-1 gap-2 mb-1">
                ...
                <a href="/jadwal" className='bg-yellow-500 mx-auto mt-1 px-3 py-2 font-semibold rounded-lg block w-fit'>Lihat Jadwal</a>
            </div>
        </div>
    )
}
