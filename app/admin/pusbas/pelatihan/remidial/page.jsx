...
export default function RemidiAdmin() {
    ...
    const getDataPesertaRemidial = async () => {
        try {
            const res = await axios.get(`/api/pusbas/peserta/remidial/periode?periode=${selectedPeriode}`);
    ...
    const handleDownloadExcel = async () => {
        try {
            const res = await fetch('/api/pusbas/peserta/remidial/export');
            ...
            a.href = url;
            a.download = 'remidial_pusbas.xlsx';
