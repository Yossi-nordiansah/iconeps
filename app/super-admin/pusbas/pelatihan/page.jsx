...
const PelatihanAdminPage = () => {
  ...
  const cards = [
    { title: 'Mahasiswa', value: jumlahMahasiswa, icon: <UserGroupIcon className="h-20 w-20" />, path: '/super-admin/pusbas/pelatihan/mahasiswa' },
    { title: 'Kelas', value: jumlahKelas, icon: <PresentationChartBarIcon className="h-20 w-20" />, path: '/super-admin/pusbas/pelatihan/kelas' },
    { title: 'Pendaftar', value: jumlahPendaftar, icon: <PencilSquareIcon className="h-20 w-20" />, path: '/super-admin/pusbas/pelatihan/pendaftar' },
    { title: 'Peserta', value: jumlahPeserta, icon: <UsersIcon className="h-20 w-20" />, path: '/super-admin/pusbas/pelatihan/peserta' },
    { title: 'Nilai', value: 0, icon: <AcademicCapIcon className="h-20 w-20" />, path: '/super-admin/pusbas/pelatihan/nilai' },
    { title: 'Lulus', value: jumlahPesertaLulus, icon: <CheckBadgeIcon className="h-20 w-20" />, path: '/super-admin/pusbas/pelatihan/lulus' },
    { title: 'Remidial', value: jumlahPesertaRemidial, icon: <ArrowPathIcon className="h-20 w-20" />, path: '/super-admin/pusbas/pelatihan/remidial' },
