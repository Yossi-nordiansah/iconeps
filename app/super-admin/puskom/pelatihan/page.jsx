...
const PelatihanAdminPage = () => {
  ...
  const cards = [
    { title: 'Mahasiswa', value: jumlahMahasiswa, icon: <UserGroupIcon className="h-20 w-20" />, path: '/super-admin/puskom/pelatihan/mahasiswa' },
    { title: 'Pendaftar', value: jumlahPendaftar, icon: <PencilSquareIcon className="h-20 w-20" />, path: '/super-admin/puskom/pelatihan/pendaftar' },
    { title: 'Kelas', value: jumlahKelas, icon: <PresentationChartBarIcon className="h-20 w-20" />, path: '/super-admin/puskom/pelatihan/kelas' },
    { title: 'Peserta', value: jumlahPeserta, icon: <UsersIcon className="h-20 w-20" />, path: '/super-admin/puskom/pelatihan/peserta' },
    { title: 'Nilai', value: 0, icon: <AcademicCapIcon className="h-20 w-20" />, path: '/super-admin/puskom/pelatihan/nilai' },
    { title: 'Lulus', value: jumlahPesertaLulus, icon: <CheckBadgeIcon className="h-20 w-20" />, path: '/super-admin/puskom/pelatihan/lulus' },
    { title: 'Remidial', value: jumlahPesertaRemidial, icon: <ArrowPathIcon className="h-20 w-20" />, path: '/super-admin/puskom/pelatihan/remidial' },
